...
CREATE TABLE `session_tab` (
  ...
  `session_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `session_userDelegate` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`session_id`),
  UNIQUE KEY `session_userDelegate_UNIQUE` (`session_userDelegate`)
